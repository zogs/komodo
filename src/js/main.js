...
window.initTest = function(env) {
    ...
    let komodo = new Blockchain({id: 'kmd', name: 'KMD Chain', color:'#41ead4', premined: 6, notarizeTo: 'btc', notaryLabelSize: "big", notarizeInterval:10});
    ...
    var komodoPlatform = new Platform({y: 260, id: 'kmd', name: ' ',color: '#41ead4', borderColor: '#41ead4', chains: [komodo], emitterTPS: 50});
