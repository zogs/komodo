import {extend, proxy, map} from '../utils';
import Victor from '../lib/victor';
import createjs from 'createjs';

export class Transaction extends createjs.Container {
  ...
  move( ) {
    ...
    if(window.TimeScale < 1) this.velocity.multiplyScalar(window.TimeScale/2);
