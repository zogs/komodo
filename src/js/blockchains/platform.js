...
export class Platform extends createjs.Container {
  ...
  drawBackground() {
    ...
    bkg.graphics.setStrokeStyle(1).beginStroke(this.params.backgroundColor).beginFill(this.params.backgroundColor+'22').drawRect(-5, 0, window.STAGEWIDTH + 10, height);
    bkg.y = this.y - this.params.chainHeight/2;
    bkg.cache(-10, -5, window.STAGEWIDTH + 15, height+10)
